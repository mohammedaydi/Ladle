...
const RecipeFilter = ({
  ...
  const filterCompHandler = (event) => {
    if (event.target.id === "recipeEntry") {
      setShowFilter(true);
    } else {
      setShowFilter(false);
    }
    ...
    <>
      {showFilter === true ? (
        <div className="recipes-filter">
          <div className="recipes-filter__close">
            <i className="fa-solid fa-x" onClick={filterCompHandler}></i>
          </div>
          <SearchBar />
        ...
        <div className="recipes-entry">
          <button type="button">
            <i
              className="fa-solid fa-arrow-down-1-9"
              id="recipeEntry"
              onClick={filterCompHandler}
            ></i>
          </button>
        </div>
      )}
